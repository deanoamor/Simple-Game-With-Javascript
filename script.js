...
if(characterCreate.length < 2){
    ...
    alert(`you have ${characterCreate.length} haracter`);
...
alert(`your character inventory are ${characterCreate[select].inventory[0][0]} will increase ${characterCreate[select].inventory[0][1]} health (${characterCreate[select].inventory[0][2]} item) and ${characterCreate[select].inventory[1][0]} will increase ${characterCreate[select].inventory[1][1]} energy (${characterCreate[select].inventory[1][2] }item)`);
console.log(`your character inventory are ${characterCreate[select].inventory[0][0]} will increase ${characterCreate[select].inventory[0][1]} health (${characterCreate[select].inventory[0][2]} item) and ${characterCreate[select].inventory[1][0]} will increase ${characterCreate[select].inventory[1][1]} energy (${characterCreate[select].inventory[1][2] }item)`);
                    ...
                    if(randomNumberForest > 5){
                        ...
                        if(characterCreate[select].energy < 50){
                            ...
                            if(useEnergyPotion === 1){
                                ...
                                alert(`you are healed and your energy is ${characterCreate[select].energy}`);
                                console.log(`you are healed and your energy is ${characterCreate[select].energy}`);
                                alert(`there are ${characterCreate[select].inventory[1][2]} energy potion left in your inventory`);
                                console.log(`there are ${characterCreate[select].inventory[1][2]} energy potion left in your inventory`);
                            }else{
                                alert(`you continue to fight`);
                            }
                        }
